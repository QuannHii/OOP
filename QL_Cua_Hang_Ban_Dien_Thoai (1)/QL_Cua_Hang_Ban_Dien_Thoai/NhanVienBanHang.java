...
public class NhanVienBanHang extends NhanVien{
    ...
    public NhanVienBanHang(String hinhthuc) {
        this.hinhthuc = hinhthuc;
    }

    public NhanVienBanHang(String hinhthuc, String maNV, float giolam) {
        super(maNV, giolam);
        this.hinhthuc = hinhthuc;
    }

    public NhanVienBanHang(String hinhthuc, String maNV, float giolam, String hoten, String diachi, String ngaysinh, String phone, String gioitinh) {
        super(maNV, giolam, hoten, diachi, ngaysinh, phone, gioitinh);
        this.hinhthuc = hinhthuc;
    }
    public NhanVienBanHang(String maNV, float giolam, String name, String diachi, String ngaysinh, String phone, String gioitinh) {
        super(maNV, giolam, name, diachi, ngaysinh, phone, gioitinh);
    }
